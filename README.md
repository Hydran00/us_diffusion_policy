...
```python
from us_dp.collection import EpisodeRecorder, read_isaac_observation
...
```python
from us_dp.collection import collect_oracle_episode
...
| Fitting locale con ancora e decoder differenziabile | `us_dp.spline`, usando le matrici upstream |
| DDPM epsilon e campionamento | `us_dp.model` + scheduler Diffusers |
...
from us_dp.anatomy import LiverFrame, read_isaac_mesh_to_world
